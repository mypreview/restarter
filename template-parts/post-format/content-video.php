...
?>
<!-- Post -->
<article id="post-<?php the_ID(); ?>" <?php post_class('tile post-tile format-video'); ?>>
	<?php 
	...
	<div class="post-thumb">
		<?php echo $the_first_video = $get_videos[0]; ?>
		<div class="post-meta">
			<?php 
	...
	<div class="tile-body post-body">
		<?php if (is_array($get_videos) && ! empty($get_videos) && ! post_password_required() && ! is_attachment()): ?>
