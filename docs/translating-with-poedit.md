...
Alternatively you can put translations in your [child theme](https://mahdiyazdani.github.io/Restarter/#/install-restarter-wordpress-child-theme): ```/wp-content/themes/restarter-child/languages/it_IT.mo```.
