<?php
/**
 * Bootstrap Navwalker - Restarter Edition
 ...
 * License 		GPL-2.0+
 */
class Restarter_Bootstrap_Navwalker extends Walker_Nav_Menu
...

	{
		if (current_user_can('manage_options'))
		{
			...
			$fb_output.= '>';
			$fb_output.= '<li><a href="' . admin_url('nav-menus.php') . '">' . esc_html__('Add a menu', 'restarter') . '</a></li>';
			$fb_output.= '</ul>';
